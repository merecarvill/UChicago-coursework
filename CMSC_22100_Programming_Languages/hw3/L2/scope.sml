...
<title>scarvill-cs221-spr-14 - /hw3/L2/scope.sml - Changes - PhoenixForge</title>
...
<form action="/projects/scarvill-cs221-spr-14/repository/changes/hw3/L2/scope.sml?rev=" id="revision_selector" method="get">  <!-- Branches Dropdown -->
...
<h2>
  <a href="/projects/scarvill-cs221-spr-14/repository/show">root</a>
    ...
    / <a href="/projects/scarvill-cs221-spr-14/repository/changes/hw3/L2/scope.sml">scope.sml</a>
...
History |
    ...
    <a href="/projects/scarvill-cs221-spr-14/repository/entry/hw3/L2/scope.sml">View</a> |


    <a href="/projects/scarvill-cs221-spr-14/repository/annotate/hw3/L2/scope.sml">Annotate</a> |

<a href="/projects/scarvill-cs221-spr-14/repository/raw/hw3/L2/scope.sml">Download</a>
(1.1 kB)
</p>
...
<form action="/projects/scarvill-cs221-spr-14/repository/diff/hw3/L2/scope.sml" method="get">
...
<td class="checkbox"><input checked="checked" id="cb-1" name="rev" onclick="$('cbto-2').checked=true;" type="radio" value="187" /></td>
...
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/186" title="Revision 186">186</a></td>
<td class="checkbox"><input id="cb-2" name="rev" onclick="$('cbto-3').checked=true;" type="radio" value="186" /></td>
<td class="checkbox"><input checked="checked" id="cbto-2" name="rev_to" onclick="if ($('cb-2').checked==true) {$('cb-1').checked=true;}" type="radio" value="186" /></td>
<td class="committed_on">04/21/2014 09:54 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>Scope.05</p></td>
</tr>


<tr class="changeset odd">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/185" title="Revision 185">185</a></td>
<td class="checkbox"><input id="cb-3" name="rev" onclick="$('cbto-4').checked=true;" type="radio" value="185" /></td>
<td class="checkbox"><input id="cbto-3" name="rev_to" onclick="if ($('cb-3').checked==true) {$('cb-2').checked=true;}" type="radio" value="185" /></td>
<td class="committed_on">04/21/2014 09:53 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>Scope.04</p></td>
</tr>


<tr class="changeset even">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/184" title="Revision 184">184</a></td>
<td class="checkbox"><input id="cb-4" name="rev" onclick="$('cbto-5').checked=true;" type="radio" value="184" /></td>
<td class="checkbox"><input id="cbto-4" name="rev_to" onclick="if ($('cb-4').checked==true) {$('cb-3').checked=true;}" type="radio" value="184" /></td>
<td class="committed_on">04/21/2014 09:45 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>Scope.03</p></td>
</tr>


<tr class="changeset odd">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/183" title="Revision 183">183</a></td>
<td class="checkbox"><input id="cb-5" name="rev" onclick="$('cbto-6').checked=true;" type="radio" value="183" /></td>
<td class="checkbox"><input id="cbto-5" name="rev_to" onclick="if ($('cb-5').checked==true) {$('cb-4').checked=true;}" type="radio" value="183" /></td>
<td class="committed_on">04/21/2014 09:45 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>Scope.02</p></td>
</tr>


<tr class="changeset even">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/182" title="Revision 182">182</a></td>
<td class="checkbox"><input id="cb-6" name="rev" onclick="$('cbto-7').checked=true;" type="radio" value="182" /></td>
<td class="checkbox"><input id="cbto-6" name="rev_to" onclick="if ($('cb-6').checked==true) {$('cb-5').checked=true;}" type="radio" value="182" /></td>
<td class="committed_on">04/21/2014 09:37 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>Scope.01</p></td>
</tr>
