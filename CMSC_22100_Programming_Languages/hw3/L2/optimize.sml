...
<title>scarvill-cs221-spr-14 - /hw3/L2/optimize.sml - Changes - PhoenixForge</title>
...
<form action="/projects/scarvill-cs221-spr-14/repository/changes/hw3/L2/optimize.sml?rev=" id="revision_selector" method="get">  <!-- Branches Dropdown -->
...
<h2>
  <a href="/projects/scarvill-cs221-spr-14/repository/show">root</a>
    ...
    / <a href="/projects/scarvill-cs221-spr-14/repository/changes/hw3/L2/optimize.sml">optimize.sml</a>
...
History |
    ...
    <a href="/projects/scarvill-cs221-spr-14/repository/entry/hw3/L2/optimize.sml">View</a> |


    <a href="/projects/scarvill-cs221-spr-14/repository/annotate/hw3/L2/optimize.sml">Annotate</a> |

<a href="/projects/scarvill-cs221-spr-14/repository/raw/hw3/L2/optimize.sml">Download</a>
(1.2 kB)
</p>
...
<form action="/projects/scarvill-cs221-spr-14/repository/diff/hw3/L2/optimize.sml" method="get">
...
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/211" title="Revision 211">211</a></td>
<td class="checkbox"><input checked="checked" id="cb-1" name="rev" onclick="$('cbto-2').checked=true;" type="radio" value="211" /></td>
<td class="checkbox"></td>
<td class="committed_on">04/23/2014 03:29 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>opt.04</p></td>
</tr>


<tr class="changeset even">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/210" title="Revision 210">210</a></td>
<td class="checkbox"><input id="cb-2" name="rev" onclick="$('cbto-3').checked=true;" type="radio" value="210" /></td>
<td class="checkbox"><input checked="checked" id="cbto-2" name="rev_to" onclick="if ($('cb-2').checked==true) {$('cb-1').checked=true;}" type="radio" value="210" /></td>
<td class="committed_on">04/23/2014 03:28 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>opt.03</p></td>
</tr>


<tr class="changeset odd">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/208" title="Revision 208">208</a></td>
<td class="checkbox"></td>
<td class="checkbox"><input id="cbto-3" name="rev_to" onclick="if ($('cb-3').checked==true) {$('cb-2').checked=true;}" type="radio" value="208" /></td>
<td class="committed_on">04/23/2014 02:43 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>opt.01</p></td>
</tr>
