...
<title>scarvill-cs221-spr-14 - /hw7/hw7-subtype/subtype.sml - Changes - PhoenixForge</title>
...
<form action="/projects/scarvill-cs221-spr-14/repository/changes/hw7/hw7-subtype/subtype.sml?rev=" id="revision_selector" method="get">  <!-- Branches Dropdown -->
...
<h2>
  <a href="/projects/scarvill-cs221-spr-14/repository/show">root</a>
    ...
    / <a href="/projects/scarvill-cs221-spr-14/repository/changes/hw7/hw7-subtype/subtype.sml">subtype.sml</a>
...
History |
    ...
    <a href="/projects/scarvill-cs221-spr-14/repository/entry/hw7/hw7-subtype/subtype.sml">View</a> |


    <a href="/projects/scarvill-cs221-spr-14/repository/annotate/hw7/hw7-subtype/subtype.sml">Annotate</a> |

<a href="/projects/scarvill-cs221-spr-14/repository/raw/hw7/hw7-subtype/subtype.sml">Download</a>
(966 Bytes)
</p>
...
<form action="/projects/scarvill-cs221-spr-14/repository/diff/hw7/hw7-subtype/subtype.sml" method="get">
...
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/339" title="Revision 339">339</a></td>
<td class="checkbox"><input checked="checked" id="cb-1" name="rev" onclick="$('cbto-2').checked=true;" type="radio" value="339" /></td>
<td class="checkbox"></td>
<td class="committed_on">06/02/2014 09:56 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>subtype.04</p></td>
</tr>


<tr class="changeset even">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/338" title="Revision 338">338</a></td>
<td class="checkbox"><input id="cb-2" name="rev" onclick="$('cbto-3').checked=true;" type="radio" value="338" /></td>
<td class="checkbox"><input checked="checked" id="cbto-2" name="rev_to" onclick="if ($('cb-2').checked==true) {$('cb-1').checked=true;}" type="radio" value="338" /></td>
<td class="committed_on">06/02/2014 09:51 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>subtype.03</p></td>
</tr>


<tr class="changeset odd">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/337" title="Revision 337">337</a></td>
<td class="checkbox"><input id="cb-3" name="rev" onclick="$('cbto-4').checked=true;" type="radio" value="337" /></td>
<td class="checkbox"><input id="cbto-3" name="rev_to" onclick="if ($('cb-3').checked==true) {$('cb-2').checked=true;}" type="radio" value="337" /></td>
<td class="committed_on">06/02/2014 09:51 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>subtype.02</p></td>
</tr>


<tr class="changeset even">
<td class="id"><a href="/projects/scarvill-cs221-spr-14/repository/revisions/336" title="Revision 336">336</a></td>
<td class="checkbox"><input id="cb-4" name="rev" onclick="$('cbto-5').checked=true;" type="radio" value="336" /></td>
<td class="checkbox"><input id="cbto-4" name="rev_to" onclick="if ($('cb-4').checked==true) {$('cb-3').checked=true;}" type="radio" value="336" /></td>
<td class="committed_on">06/02/2014 09:35 pm</td>
<td class="author">Spencer Carvill</td>
<td class="comments"><p>subtype.01</p></td>
</tr>
...
<td class="checkbox"></td>
<td class="checkbox"><input id="cbto-5" name="rev_to" onclick="if ($('cb-5').checked==true) {$('cb-4').checked=true;}" type="radio" value="322" /></td>
